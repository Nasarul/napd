...
<div class="container-fluid">
	<div class="row">
		<div class="col-lg-12">
					...
					<a href="<?php echo base_url . 'admin' ?>" class="portal-link">
						<div class="card card-widget widget-user">
							...
							<div class="card-footer bg-info">
								<div class="container">
									<p class="text-center text-white-50"><small><i>Click here for Admin</i></small></p>
								</div>
							</div>
						</div>
					</a>
				...
				<div class="col-md-4">
					<a href="<?php echo base_url . 'faculty' ?>" class="portal-link">
						<div class="card card-widget widget-user">
							...
							<div class="card-footer bg-info">
								<div class="container">
									<p class="text-center text-white-50"><small><i>Click here for Faculty</i></small></p>
								</div>
							</div>
						</div>
					</a>
					...
					<a href="<?php echo base_url . 'student' ?>" class="portal-link">
						<div class="card card-widget widget-user">
							...
							<div class="card-footer bg-info border-info">
								<div class="container">
									<p class="text-center text-white-50"><small><i>Click here for Students</i></small></p>
								</div>
							</div>
						</div>
					</a>
			...
			<section>
				<div class="col-lg-12">
					<h1 class="text-center">Online Lecture Management System</h1>
